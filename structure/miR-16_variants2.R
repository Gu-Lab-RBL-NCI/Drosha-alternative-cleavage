...
cl_mir <- read.table(file="GSM1658993_16_barcode_cleavage_fragments.txt", header = TRUE, fill = FALSE, sep =  "\t")
cl_mir$counts <- 1
...
variant_count_mir <- read.table(file="GSM1658987_16_dictionary.txt", header = FALSE, fill = FALSE, sep =  "\t")
#barcount_mir <- read.table(file="GSM1658990_16_input_barcode_counts.txt", header = TRUE, fill = FALSE, sep =  "\t")
...
write.table(summary_fidelity, "mir16-variants-cleavage-distribution.txt", sep="\t", append = FALSE, col.names = TRUE, row.names = FALSE)
...
write.table(summary_energy, "mir16-summary-energy-cleavage.txt", sep="\t", append = FALSE, col.names = TRUE, row.names = FALSE)
